...
<body>
    <div class="container-login100" style="background-image: url('images/b12.jpg');">
...
<body>
    <div class="content">
        ...
        <form action="add.php" method="POST" enctype="multipart/form-data">
            ...
            <h3><div>Select images: <input type="file" name="images"></div></h3><br>
            <button type="submit" value="Add" name="submit">Add</button>
        </form>
        
        <h4><button><a href="/managing.php">Back</a></button></h4>
    </div>
</body>
